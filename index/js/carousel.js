...
// 鼠标移动到左右箭头的位置更换图片 有灰色背景的图片
    leftArrow.addEventListener('mouseenter', function() {
        this.style.backgroundImage = 'url(images/left_darkarrow.png)';
    });

    leftArrow.addEventListener('mouseleave', function() {
        this.style.backgroundImage = 'url(images/left_lightarrow.png)';
    });

    rightArrow.addEventListener('mouseenter', function() {
        this.style.backgroundImage = 'url(images/right_darkarrow.png)';
    });

    rightArrow.addEventListener('mouseleave', function() {
        this.style.backgroundImage = 'url(images/right_lightarrow.png)';
    });
